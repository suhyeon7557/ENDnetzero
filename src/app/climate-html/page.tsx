export default function ClimateHTMLPage() {
  return (
            ...
            <div className="section">
              ...
              <div className="ozone_note_group">
                ...
                <div className="note_list">
                  ...
                  <p className="note">태양에서 오는 빛은 일부가 지구에 흡수되고 일부는 우주로 빠져나가야 하지만 <span>공장, 차량, 화석연료</span> 사용 등에서 배출되는 온실가스가 이 열을 가두어 지구온난화를 일으킵니다.</p>
                  <br />
